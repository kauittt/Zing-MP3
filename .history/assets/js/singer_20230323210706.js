...
function loadInfor(data) {
    ...
    heading.styles.backgroundImage = `url(${data.cover})`;
    heading.styles.backgroundImage = `url(https://scontent.fsgn2-7.fna.fbcdn.net/v/t39.30808-6/337421250_1273125283586945_8692249315833457831_n.jpg?_nc_cat=100&ccb=1-7&_nc_sid=5cd70e&_nc_ohc=mPSjl-xLwOsAX8qMeGU&_nc_ht=scontent.fsgn2-7.fna&oh=00_AfD8SM9e4XgfEZpaXH2v9sW36X9UxdYivfWQil_UusIUHA&oe=642074F9)`;
