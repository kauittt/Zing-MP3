...
btns[4].addEventListener("click", function (e) {
    ...
    console.log(listSong_content);
    console.log(list);
    // console.log(list.querySelector(`:nth-child(0)`));
    // console.log(list.querySelector(`:nth-child(1)`));
    console.log(list.querySelector(`.listSong-content-list-item:nth-child(2)`));
    // console.log(list.querySelector(`:nth-child(3)`));
    // console.log(list.querySelector(`:nth-child(4)`));
    console.log(
        list
            .querySelector(`:nth-child(6)`)
            .querySelector(".listSong-content-list-item-infor-img")
    );
    list.querySelector(`:nth-child(2)`)
        .querySelector(".listSong-content-list-item-infor-img")
        .click();
});
