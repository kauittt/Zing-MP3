...
function loadListContent(
    ...
    const infor = `
    <div class="${query}-item-infor">
        <i class="fa-solid fa-music"></i>
        <div
            class="${query}-item-infor-img" data-id="${data.encodeId}"
        >
            <img
                src="${data.thumbnailM}"
                alt=""
        ...
        <div
            class="${query}-item-infor-song"
        >
            <h3
                class="${query}-item-infor-song__name"
            >
                ${data.title}
            </h3>
            <p
                class="${query}-item-infor-song__singer"
            >
            </p>
        </div>
    </div>
`;
    ...
    if (album) {
        item.insertAdjacentHTML(
            "beforeend",
            `
            <p class="${query}-item__album" data-id="${
