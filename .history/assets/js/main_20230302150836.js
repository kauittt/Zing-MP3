...
listSong_content.addEventListener("click", async function (e) {
    if (e.target.closest(".listSong-content-list-item-infor-img")) {
        ...
        wrapList
            .querySelector(`div[data-id="${songPlaying.dataset.id}"]`)
...
async function handlePlayMusic(item) {
    ...
    const img = document.querySelector(".play-infor-img");
    ...
    console.log(item.querySelector("img").getAttribute("src"));
