...
async function handleItemClick(e, id = null) {
    ...
    // const response = await fetch(
    //     `https://zing-mp3-api.vercel.app/api/playlist/ZABDOABU`
    // );
    const { data } = await response.json();
    ...
    <div class="listSong-content-list-item-infor">
        ...
        ${
            data.streamingStatus == 2
                ? `<div class="vip">
        <img src="https://zing-mp3-clone-three.vercel.app/static/media/vip-label.ddbac03b04ea429116ca6f7aad90416b.svg" alt="">
    </div>`
                : ""
        }
    </div>
...
logo.addEventListener("click", function (e) {
    mp3.src =
        "https://mp3-s1-zmp3.zmdcdn.me/fac48e06b2465b180257/1072001800942752349?authen=exp=1677833263~acl=/fac48e06b2465b180257/*~hmac=e9b25955aec95c568be71e52a60a80d5&fs=MTY3NzY2MDQ2Mzg0Nnx3ZWJWNnwxMDA2NDk4MTgyfDE0LjE2Ny43OS4xODY";
});
