...
async function handleItemClick(e, id = null) {
    if (!id) {
        ...
        if (
            !e.target.closest(".section-list-item-img") ||
            !e.target.closest(".section-list-item__heading")
        ) {
            console.log("no");
            return;
        }
        // if (!e.target.closest(".section-list-item-img")) return;
        // if (!e.target.closest(".section-list-item__heading")) return;
