...
const listSong_content_list = document.querySelector(".listSong-content-list");
console.log(listSong_content_list);
...
wrapList.addEventListener("click", async function (e) {
    if (e.target.closest(".playList-wrapper-item-img")) {
        ...
        if (songPlaying && songPlaying.classList.remove("selected"))
            console.log("removed");
