...
btns[1].addEventListener("click", function (e) {
    ...
    songPlaying = songPlaying.previousElementSibling.querySelector(
        ".listSong-content-list-item-infor-img"
    );
    songPlaying.previousElementSibling.classList.add("selected");
...
btns[3].addEventListener("click", function (e) {
    const songPlaying = songPlaying.parentNode.parentNode;
    songPlaying.classList.remove("selected");
    songPlaying = songPlaying.nextElementSibling.querySelector(
        ".listSong-content-list-item-infor-img"
    );
    songPlaying.nextElementSibling.classList.add("selected");
